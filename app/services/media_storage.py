...
class MediaStorageService:
    ...
    def _needs_s3(self) -> bool:
        ...
        return self.settings.media_storage_mode in [MediaStorageMode.S3_ONLY, MediaStorageMode.LOCAL_WITH_S3]
    ...
    async def store_video(self, source_file: Path) -> dict:
        ...
        """
        try:
            result = {"storage_mode": self.settings.media_storage_mode.value}
